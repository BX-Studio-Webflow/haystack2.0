...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    async function getPerson(slug) {
        try {
            const res = await xano_pft_individual_pages.get("/person", {
                slug,
            });
            ...
            personCards.forEach((personCard) => {
                ...
                personCompanyLink.href = "/pft/company_pft/" + person.company_details.slug;
    ...
    async function getPersonInsights(slug, payload) {
        ...
        try {
            const res = await xano_pft_individual_pages.get("/person_insights", {
                slug,
                page,
                perPage,
                offset,
